...
const pillars = [
  ...
  },
  {
    ...
    signals: ['Autoscaling policies', 'Stateless service design', 'Periodic load testing'],
  },
  {
    index: '05',
    ...
    signals: [
      'Fast, honest CI feedback loops',
      'Local-to-prod environment parity',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-1">
            {pillars.map((p) => (
              <div
                key={p.index}
                className="group flex flex-col md:flex-row gap-8 p-10 bg-surface-container border-l-2 border-outline-variant/20 hover:border-primary/40 hover:bg-surface-container-high transition-all"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {startupFit.map((item) => (
              <div
                ...
                className="bg-surface-container border-t border-white/5 p-8 hover:bg-surface-container-high transition-all"
              >
                <h4 className="font-headline text-lg font-bold mb-4 text-primary">{item.point}</h4>
