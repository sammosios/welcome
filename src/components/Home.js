...
function Home({setCurrentPage}) {
  ...
  return (
    <div style={{ textAlign:'center'}}>
        ...
        Press <a href onClick={() => setCurrentPage('Tech profile')}>here</a> to explore my tech profile, or <a href onClick={() => setCurrentPage('Experience')}>here</a> if you want to see my career history so far.
        </p>
        </div>
    </div> 
  );
